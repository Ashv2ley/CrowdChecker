                            ...
                            >
                                ...
                                >
                                    ...
                                    <View style={styles.container}>
                                        <TouchableOpacity
                                            onPress={() => setReportedDensity("low")}
                                            style={[
                                                styles.densityButton,
                                                { borderColor: "#7ABD7E" },
                                                reportedDensity === "low" && { backgroundColor: "#E0F3E2" } // darker green bg
                                            ]}
                                        >
                                        ...
                                        <TouchableOpacity
                                            onPress={() => setReportedDensity("moderate")}
                                            style={[
                                                styles.densityButton,
                                                { borderColor: "#FFC571" },
                                                reportedDensity === "moderate" && { backgroundColor: "#FFF2D8" } // darker yellow bg
                                            ]}
                                        >
                                        ...
                                        <TouchableOpacity
                                            onPress={() => setReportedDensity("high")}
                                            style={[
                                                styles.densityButton,
                                                { borderColor: "#E06666" },
                                                reportedDensity === "high" && { backgroundColor: "#FBE5E5" } // darker red bg
                                            ]}
                                        >
